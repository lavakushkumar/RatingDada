 ...
 */
public class MoviesAdapter_dashboard extends BaseAdapter {
     ArrayList<MoviesDo> vectForm;
     Context ctx;
     LayoutInflater inflator;

    @SuppressWarnings("unchecked")
    public MoviesAdapter_dashboard(ArrayList<MoviesDo> vectForm, Context ctx) //, LayoutInflater inflator
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //try {
            ...
            if (itemView == null) {
                itemView = inflator.inflate(R.layout.listmovies_dashboard, parent, false);
            }
